        ...
        <div className="bg-white grid grid-cols-1 rounded-lg md:grid-cols-2 p-4">
            ...
            <div className="pt-2 pb-4 pr-4 pl-5">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div>
                        <button className="px-2 py-0.5 border-solid border-[rgb(196_196_207)] border-[1px] rounded">Cập nhật</button>
                    </div>
                </div>
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-x-2">
                        ...
                        <div className="flex flex-col">
                            <span>Email</span>
                            <span>nguyenhaiyen@gmail.com</span>
                        </div>
                    </div>
                    <div>
                        <button className="px-2 py-0.5 border-solid border-[rgb(196_196_207)] border-[1px] rounded">Cập nhật</button>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div>
                        <button className="px-2 py-0.5 border-solid border-[rgb(196_196_207)] border-[1px] rounded">Thay đổi</button>
                    </div>
                </div>
            </div>
        </div>
